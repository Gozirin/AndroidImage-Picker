...
import com.github.gozirin.imagepicker.ImagePicker
import com.github.gozirin.imagepicker.ImagePickerActivity
import com.github.gozirin.imagepicker.util.ExifDataCopier
import com.github.gozirin.imagepicker.util.FileUtil
import com.github.gozirin.imagepicker.util.ImageUtil
import java.io.File
        ...
        object : AsyncTask<Uri, Void, File>() {
            ...
            override fun onPostExecute(file: File?) {
                ...
                if (file != null) {
                    ...
                    // Post Error
                    setError(com.github.gozirin.imagepicker.R.string.error_failed_to_compress_image)
                }
            }
        }.execute(uri)
    }
